...
public interface ReferenceLinkRepo extends JpaRepository<ReferenceLink, String> {
  ...
  public List<ReferenceLink> findAllByTypeNameAndExternalReference(@Param("typeName") String typeName, @Param("externalReference") String externalReference);

  // public List<ReferenceLink> findAllByTypeId(@Param("typeId") String typeId);

  public List<ReferenceLink> findAllByTypeIdAndExternalReference(@Param("typeId") String typeId, @Param("externalReference") String externalReference);

  public List<ReferenceLink> findAllByFolioReference(@Param("folioReference") String folioReference);

  @Transactional(readOnly = true)
  public Stream<ReferenceLink> findAllByTypeId(@Param("typeId") String typeId);
